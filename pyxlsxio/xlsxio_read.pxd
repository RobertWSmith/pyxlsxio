...
cdef extern from "xlsxio_read.h":
    ...
    #    * \sa         xlsxioread_close()
    #    */
    xlsxioreader xlsxioread_open_memory (void* data, uint64_t datalen, int freedata) nogil
    ...
    #    */
    ctypedef int (*xlsxioread_list_sheets_callback_fn)(const char* name, void* callbackdata) nogil
    ...
    #    */
    void xlsxioread_list_sheets (xlsxioreader handle, xlsxioread_list_sheets_callback_fn callback, void* callbackdata) nogil
    ...
    #    */
    ctypedef int (*xlsxioread_process_cell_callback_fn)(size_t row, size_t col, const char* value, void* callbackdata) nogil
    ...
    #    */
    ctypedef int (*xlsxioread_process_row_callback_fn)(size_t row, size_t maxcol, void* callbackdata) nogil
    ...
    #    * \sa         xlsxioread_process_cell_callback_fn
    #    */
    int xlsxioread_process (xlsxioreader handle, const char* sheetname, unsigned int flags, xlsxioread_process_cell_callback_fn cell_callback, xlsxioread_process_row_callback_fn row_callback, void* callbackdata) nogil
    ...
    #    * \sa         xlsxioread_open()
    #    */
    xlsxioreadersheet xlsxioread_sheet_open (xlsxioreader handle, const char* sheetname, unsigned int flags) nogil
    ...
    #    */
    int xlsxioread_sheet_next_cell_string (xlsxioreadersheet sheethandle, char** pvalue) nogil
    ...
    #    * \sa         xlsxioread_sheet_next_cell()
    #    */
    int xlsxioread_sheet_next_cell_int (xlsxioreadersheet sheethandle, int64_t* pvalue) nogil
    ...
    #    * \sa         xlsxioread_sheet_next_cell()
    #    */
    int xlsxioread_sheet_next_cell_float (xlsxioreadersheet sheethandle, double* pvalue) nogil
    ...
    #    * \sa         xlsxioread_sheet_next_cell()
    #    */
    int xlsxioread_sheet_next_cell_datetime (xlsxioreadersheet sheethandle, time_t* pvalue) nogil
